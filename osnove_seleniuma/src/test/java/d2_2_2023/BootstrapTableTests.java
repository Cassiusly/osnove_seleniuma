...
public class BootstrapTableTests {
    ...
    public void beforeMethod() {
        ...
        this.listaPodatakaPolaznika.add("Anita");
        this.listaPodatakaPolaznika.add("Nestorovic");
        this.listaPodatakaPolaznika.add("Violeta");
    ...
    public void takeScreenshot() throws IOException {
        new Helper().takeScreenshot(driver, "src/test/screenshots/slike/" + ".png");
    }
